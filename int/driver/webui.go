...
import (
	...
	"github.com/codeperfio/pprof/int/graph"
	"github.com/codeperfio/pprof/int/plugin"
	"github.com/codeperfio/pprof/int/report"
...
func (ui *webInterface) render(w http.ResponseWriter, req *http.Request, tmpl string,
	...
	if err := ui.templates.ExecuteTemplate(html, tmpl, data); err != nil {
		http.Error(w, "int template error", http.StatusInternalServerError)
		ui.options.UI.PrintErr(err)
		return
	}
